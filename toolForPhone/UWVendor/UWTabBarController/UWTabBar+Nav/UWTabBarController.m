...
- (CYLTabBarController *)tabBarController
{
    if (_tabBarController == nil) {
        UWHomeVC *firstViewController = [[UWHomeVC alloc] init];
        ...
        UWMapListVC *thirdViewController = [[UWMapListVC alloc] init];
        UWNavigationController *thirdNavigationController = [[UWNavigationController alloc]
                                                             initWithRootViewController:thirdViewController];
        
        UWMineVC *fourthViewController = [[UWMineVC alloc] init];
